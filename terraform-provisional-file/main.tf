...
# copy file from your local machine to your virtual machine in this case jenkins
resource "null_resource" "copy-file" {
   provisioner "file" {

     source      = "~/Downloads/devops/dommy-instance/ansi-iam.tf"
    #  source      = "~/Downloads/sweet.txt"   working
    destination = "/home/ec2-user/test2/ansi-iam.tf"
   # destination = "/home/ec2-user/test/sweet.txt" working
  ...
  connection {
      ...
      user        = "ec2-user"
      private_key = file("~/Downloads/devops/terraform-test/terraform-provisional-file/keypair.pem")
      timeout     = "4m"
   ...
   # notes 1: you need to automate your prv keypair ready before you apply null resource OR you apply first you infrasture but you apply the null resources
